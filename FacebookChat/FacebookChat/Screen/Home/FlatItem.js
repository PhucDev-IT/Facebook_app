...
const FlatItem = memo((props) => {
  ...
  // console.log(JSON.stringify(User)+"cuẻn")
  // console.log(JSON.stringify(data) + 'deataa');
  const tym = async () => {};
  const DetaiHandress = async () => {
    // console.log(data +'gausa')
    if (data.userID === userCurrent.userID) {
      return;
    }
    ...
    navigation.navigate("SeeDetails", userData);
  };
